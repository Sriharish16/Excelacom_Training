...
public class Application {
	...
	public static void main(String[] args) {
		...
		BankAccount ram =new BankAccount(5000, "Ramesh", 5000,"Saving");
		BankAccount shyam = new BankAccount(6200,"Rajesh",5000,"saving");
		
		double simpleInterest =service.calculateInterest(ram);
		System.out.println("Simple Interest ram:="+simpleInterest);
		
		double simpleInterest2 =service.calculateInterest(shyam);
		System.out.println("Simple Interest shyam:"+simpleInterest2);
...
//		accounts[1]=shyam;
	...
	//	service.calculateInterest(accounts);
		...
		System.out.println("ss:"+eachValue);
	}
